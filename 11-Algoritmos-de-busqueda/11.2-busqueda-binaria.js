...
const elementoBuscar = 4;

const resultIndex = busquedaBinaria(arregloBusqueda,elementoBuscar);

if (resultIndex !== -1) {
    console.log(`El elemento ${elementoBuscar} se encuentra en el indece ${resultIndex}`);
} else{
    console.log(`El elemento ${elementoBuscar} no se encuentra en ningun indice`);
}